...
<head>
    <title>NAIROBI CITY MORTUATY MANAGEMENT SYSTEM</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <nav class="navbar navbar-toggleable-md">
        ...
        <a class="navbar-brand logo" href="index.php" style="color: white">
           <h4><strong>NAIROBI CITY MORTUARY MANAGEMENT SYSTEM</strong></h4>
        </a>
    ...
    <div class="sidebar-content">
        <ul class="navigation">
            ...
            <li>
                <a href="services.php"><i class="fa fa-cab"></i> <span>Services</span></a>
            </li>
             <li>
             ...
             <li>
                <a href="mail.php"><i class="fa fa-envelope"></i> <span>eMail</span></a>
            </li>
            <li>
                <a href="reports.php"><i class="fa fa-download"></i> <span>Reports</span></a>
            </li>
